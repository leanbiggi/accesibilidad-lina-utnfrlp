...
* **[Reporte de Análisis Preliminar](./docs/Analisis-Preliminar-UTNFRLP.pdf):** Detalle de hallazgos iniciales sobre roles ARIA faltantes y gestión de contenido no textual.
